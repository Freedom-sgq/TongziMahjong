...
var warn = function warn(message: string) {
    BPLog.warn(message);
};
...
function transformPhrase(
    ...
    result = replace.call(result, interpolationRegex, function (expression, argument) {
        if (!options.hasOwnProperty(argument) || options[argument] == null) { return expression; }
...
function entries(o: Record<string, any>): any[] {
    let entries: any[] = [];
    for (let k in o) {
        entries.push([k, o[k]]);
    }
...
function forEach(array: Array<any>, callbackfn: any, ...args: any[]): void | undefined {
    return array.forEach(callbackfn, args[0]);
}
 ...
 * @description
 */
export class BPPolyglot {

    private phrases: Record<string, any>;
    private currentLocale: string;
    private onMissingKey: Function;
    private warn: (message: string) => void;
    private replaceImplementation: any;
    private tokenRegex: RegExp;
    private pluralRules: Record<string, any>;
    ...
    extend(morePhrases: Record<string, any>, prefix?: string) {
    ...
    unset(morePhrases: Record<string, any>, prefix: string) {
    ...
    replace(newPhrases: Record<string, any>) {
        this.clear();
